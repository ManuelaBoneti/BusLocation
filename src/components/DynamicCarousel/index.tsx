...
const styles = StyleSheet.create({
  carouselContainer: { alignItems: "center", justifyContent: "center", width: "100%", marginVertical: 20 },
  slideWrapper: { alignItems: "center", justifyContent: "center", width: screenWidth },
  navButton: { position: "absolute", top: "45%", backgroundColor: "rgba(0,0,0,0.4)", padding: 8, borderRadius: 30, zIndex: 2 },
  leftButton: { left: 20 },
